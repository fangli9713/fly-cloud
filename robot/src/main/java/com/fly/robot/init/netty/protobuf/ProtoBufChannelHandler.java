...
/**
  ...
  * @date 2019/5/30
  */
public class ProtoBufChannelHandler extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel ch){
       ...
       // pipeline.addLast( new IdleStateHandler(60, 60, 60,TimeUnit.SECONDS));
         ...
         */
        pipeline.addLast(new ProtobufDecoder(BaseMsgOuterClass.BaseMsg.getDefaultInstance()));
        /**
