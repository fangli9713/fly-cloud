package com.fly.common.netty.client;
...
public class NettyClientProtoBufInitializer extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel ch) throws Exception {
        ...
        channelPipeline.addLast( new IdleStateHandler(10, 10, 10, TimeUnit.SECONDS));
        /**
         ...
         */
        channelPipeline.addLast(new ProtobufDecoder(BaseResultOuterClass.BaseResult.getDefaultInstance()));
        /**
