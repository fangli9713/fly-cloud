package com.fly.cloud.uiclient.demo;
...
public class SwingSet2 extends JPanel {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new SwingSet2(GraphicsEnvironment.
    ...
    public void initializeDemo() {
        ...
        JLabel hintLabel = N9ComponentFactory.createLabel_style1("开心一刻");
    ...
    void loadDemo(String classname) {
        ...
        try {
            String pg = "com.fly.cloud.uiclient.demo.";
            Class demoClass = Class.forName(pg + classname);
