package com.fly.operate.mybatisplus;
...
public class MybatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir")+"/operate"; //项目目录
        ...
        pc.setParent("com.fly.operate");
        pc.setService("service");
        pc.setServiceImpl("service.impl");  //在service.impl包下生成Impl
        pc.setXml("mapper.operate");  //在mapper生成xml
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                return "D:\\personal-project\\fly-cloud\\operate\\src\\main\\resources" + "/mapper/finance/" + tableInfo.getEntityName() + "Mapper.xml";
            }
        });
